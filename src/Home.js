...
export default function Home() {
  ...
  console.log(numberOfMultiservers)
...
//****************************************   Single Server Function ************************************************************
  ...
  function SingleServerQueue( lambda, meu, max = 0, min = 0, varianceST = 0,varianceAT = 0) 
  {
    ...
    ) 
    {
      ...
      setError("Please Select Proper Distributions")
      setTimeout(() => {
        setError("")
      }, 3000);
    }
...
//******************************************** Performance measures function ********************************************* */
  ...
  return (
    <>
      ...
      <h1 style={{fontSize:"50px",textAlign:"center",color:"white",textShadow:"2px 2px black"}}>UNITED BANK LIMITED QUEUEING SIMULATOR</h1>
      <div className="container">
        ...
        {/* ********************************************Minimum and maximum ****************************************************/}
            ...
            {(
               ((distributionArrivalTime === "Exponential" || distributionArrivalTime === "Poisson" ) && distributionServiceTIme === "Gamma")  || 
               ((distributionArrivalTime === "Exponential" || distributionArrivalTime === "Poisson" ) && distributionServiceTIme === "Normal") || 
               ((distributionArrivalTime === "Exponential" || distributionArrivalTime === "Poisson" ) && distributionServiceTIme === "Uniform")) && (
            <div>
              <h1>variance</h1>
              <input type="number" onChange={(e)=> setuserVarinace(e.target.value)} min={0} required/>
            </div>
              )}
   ...
   {/* ******************************************** Variance of Service and  Arrival time ****************************************************/}
        ...
        {server == 2 && (
          ...
          <div className="servers2" >
            ...
            <input type="number" placeholder="Enter number of server" onChange={(e)=>setNumberOfMultiservers(e.target.value)} min={2}/>
